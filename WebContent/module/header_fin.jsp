...
<head>
    ...
    *{margin: 0; padding: 0;}
	...
	.third_header .col_2nd .btn_group img,a,.a_dropdown{
	z-index: 1000;
	}
...
//     	let logOutbtn = $('.first_header .col_4th .logOutbtn');
...
// 	});
    ...
    /* 두번째 헤더의 우측 장바구니 연결 */
	function cartpage() {
      let CartPageURL = "http://localhost:8080/semi_project/CartPage.jsp";
    ...
    <div class="container first_header">
        ...
        <div class="row first_row">
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col_2nd">
                <button type="button" class="btn btn-link" style="color: black">010-2222-3333</button>
            </div>
            <!-- 센터 공백 -->
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col_4th">
                ...
                <c:if test="${sessionScope.user_id == null }">
                    ...
                    <ul class="dropdown-menu text-center first_drop">
                        ...
                        <li><a class="dropdown-item" href="userLogin.jsp"><span class="span1">로그인</span></a></li>
                        <li><a class="dropdown-item" href="JoinPage.jsp">회원가입</a></li>
                    </ul>
                    
                </c:if>
                
                <!-- 일반 유저가 로그인하면 -->
                <c:if test="${sessionScope.user_id != null && sessionScope.user_id.indexOf('admin') == -1}">
                    <button type="button" class="btn dropdown-toggle Logoutbtn" data-bs-toggle="dropdown" aria-expanded="false"
                    		style="font-size: 15px">
                    <span style="color: #3ed4be; font-weight: bolder; font-size: 17px;">${sessionScope.user_id }</span>&nbsp;로그아웃
                    </button>
                ...
                %>
                <!-- 관리자가 로그인 하면 -->
                <c:if test="${sessionScope.user_id != null && sessionScope.user_id ne '' && sessionScope.user_id.indexOf('admin') != -1}">
                    <button type="button" class="btn dropdown-toggle Logoutbtn" data-bs-toggle="dropdown" aria-expanded="false"
                    		style="font-size: 15px">
                    <span style="color: #3ed4be; font-weight: bolder; font-size: 17px;">${sessionScope.user_id }</span>&nbsp;로그아웃
                    </button>
                    ...
                    <ul class="dropdown-menu text-center first_drop">
                        ...
                        <li><a class="dropdown-item" href="#">내 게시글 보기</a></li>
                        <li class="dropdown-divider">- - - -</li>                        
                        <li><a class="dropdown-item" href="http://localhost:8080/semi_project/AddProductPage.jsp"><span class="span1">상품등록</span></a></li>
<!--                         <li><a class="dropdown-item" href="http://localhost:8080/semi_project/JoinPage.jsp">회원가입</a></li> -->
                    </ul>
    ...
    <div class="container second_header">
        <div class="row second_row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col_2nd">
                    <H2 class="head_title">
                    <a href="./MainPage.jsp">
                    <img src="https://puppydog.co.kr/web/upload/appfiles/0zdpAngaKBFnlCcCqpCU4A/3642e66df2340bdc448e87f7b3b2e756.png" style="width: 260px; height: 130xp;"></a></H2>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col_3rd">
                ...
                <button type="button" onclick="cartpage()" class="btn popover_3rd" data-toggle="popover" title="장바구니" data-placement="bottom">
...
<!-- 세번째 헤더부분~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
    ...
    <div class="container third_header w-100">
